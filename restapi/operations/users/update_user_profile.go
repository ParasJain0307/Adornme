...
type UpdateUserProfileHandlerFunc func(UpdateUserProfileParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateUserProfileHandlerFunc) Handle(params UpdateUserProfileParams, principal *models.Principal) middleware.Responder {
...
type UpdateUserProfileHandler interface {
	Handle(UpdateUserProfileParams, *models.Principal) middleware.Responder
}
...
/*
	UpdateUserProfile swagger:route PUT /users/me Users updateUserProfile
