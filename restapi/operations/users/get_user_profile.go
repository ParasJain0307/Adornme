...
type GetUserProfileHandlerFunc func(GetUserProfileParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUserProfileHandlerFunc) Handle(params GetUserProfileParams, principal *models.Principal) middleware.Responder {
...
type GetUserProfileHandler interface {
	Handle(GetUserProfileParams, *models.Principal) middleware.Responder
}
...
/*
	GetUserProfile swagger:route GET /users/me Users getUserProfile
