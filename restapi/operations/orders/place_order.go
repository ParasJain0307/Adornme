...
type PlaceOrderHandlerFunc func(PlaceOrderParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn PlaceOrderHandlerFunc) Handle(params PlaceOrderParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// PlaceOrderHandler interface for that can handle valid place order params
type PlaceOrderHandler interface {
	Handle(PlaceOrderParams, *models.Principal) middleware.Responder
}
...
/*
	PlaceOrder swagger:route POST /orders Orders placeOrder
