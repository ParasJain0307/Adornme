...
type GetUsersIDHandlerFunc func(GetUsersIDParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUsersIDHandlerFunc) Handle(params GetUsersIDParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetUsersIDHandler interface for that can handle valid get users ID params
type GetUsersIDHandler interface {
	Handle(GetUsersIDParams, interface{}) middleware.Responder
}
...
/*
	GetUsersID swagger:route GET /users/{id} AdminUsers getUsersId
