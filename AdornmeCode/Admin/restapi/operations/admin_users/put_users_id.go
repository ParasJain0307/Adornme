...
type PutUsersIDHandlerFunc func(PutUsersIDParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PutUsersIDHandlerFunc) Handle(params PutUsersIDParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// PutUsersIDHandler interface for that can handle valid put users ID params
type PutUsersIDHandler interface {
	Handle(PutUsersIDParams, interface{}) middleware.Responder
}
...
/*
	PutUsersID swagger:route PUT /users/{id} AdminUsers putUsersId
