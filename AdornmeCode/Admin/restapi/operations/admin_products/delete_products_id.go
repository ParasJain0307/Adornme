...
type DeleteProductsIDHandlerFunc func(DeleteProductsIDParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteProductsIDHandlerFunc) Handle(params DeleteProductsIDParams, principal interface{}) middleware.Responder {
...
type DeleteProductsIDHandler interface {
	Handle(DeleteProductsIDParams, interface{}) middleware.Responder
}
...
/*
	DeleteProductsID swagger:route DELETE /products/{id} AdminProducts deleteProductsId
